...
public class PersonController {
    ...
    public HttpResponseVo addPerson(@RequestBody PersonVo personVo){
        return HttpResponseVo.ok(this.personService.addPerson(personVo));
    }

    @ApiOperation(value = "修改一个人员信息", notes = "modify one person")
    @RequestMapping(method = RequestMethod.PUT)
    public HttpResponseVo modifyPerson(@RequestBody PersonVo personVo){
    ...
    public HttpResponseVo deletePerson(@ApiParam(name = "id", value = "人员id") @PathVariable int id){
